...
//-------DOC TEMPLATE
   ...
   // conn.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/c82d5c358495e8ef15916.mp4' }, gifPlayback: true, gifAttribution: ~~(Math.random() * 2), caption: text.trim(), footer: 'ᴍᴀᴅᴇ ᴡɪᴛʜ ❤ ʙʏ ɪᴍ-ʏᴀɴxɪᴀᴏ', templateButtons: [{ quickReplyButton: { displayText: 'Speedtest⚡', id: `${_p}speedtest` }}, { quickReplyButton: { displayText: 'Owner🎀', id: `${_p}owner` }} ] })
    ...
    requestPaymentMessage: {
     ...
     //const _0x41386d=_0xf862;function _0xf862(_0x411599,_0x17f352){const _0x523aeb=_0x523a();return _0xf862=function(_0xf862e,_0x14cbaa){_0xf862e=_0xf862e-0x105;let _0x1d5398=_0x523aeb[_0xf862e];return _0x1d5398;},_0xf862(_0x411599,_0x17f352);}function _0x523a(){const _0x1bb0a6=['sendMessage','pdf','./thumbnail.jpg','78TZglKm','462660TMDgQG','431195TFUXdU','chat','.ping','.menu','7234360OZlbTp','1500214KtRVko','4946788PTPoZz','titlebot','2680872vhwSLH','readFileSync','sig','1021260uCGonx','trim','ᴍᴇɴᴜ'];_0x523a=function(){return _0x1bb0a6;};return _0x523a();}(function(_0x255920,_0xfe8564){const _0x56069b=_0xf862,_0x50fd56=_0x255920();while(!![]){try{const _0xa9aa8d=parseInt(_0x56069b(0x113))/0x1+-parseInt(_0x56069b(0x10d))/0x2+-parseInt(_0x56069b(0x110))/0x3+-parseInt(_0x56069b(0x107))/0x4+parseInt(_0x56069b(0x108))/0x5*(parseInt(_0x56069b(0x106))/0x6)+-parseInt(_0x56069b(0x10e))/0x7+parseInt(_0x56069b(0x10c))/0x8;if(_0xa9aa8d===_0xfe8564)break;else _0x50fd56['push'](_0x50fd56['shift']());}catch(_0x269331){_0x50fd56['push'](_0x50fd56['shift']());}}}(_0x523a,0x8dbe6));const buttons=[{'buttonId':_0x41386d(0x10b),'buttonText':{'displayText':_0x41386d(0x115)},'type':0x1},{'buttonId':'.creator','buttonText':{'displayText':'ᴄʀᴇᴀᴛᴏʀ'},'type':0x1},{'buttonId':_0x41386d(0x10a),'buttonText':{'displayText':'ᴘɪɴɢ'},'type':0x1}];let buttonMessage={'document':{'url':sig},'mimetype':td,'fileName':wm,'fileLength':fsizedoc,'pageCount':fpagedoc,'contextInfo':{'externalAdReply':{'showAdAttribution':!![],'mediaUrl':global[_0x41386d(0x112)],'mediaType':0x2,'previewType':_0x41386d(0x117),'title':global[_0x41386d(0x10f)],'body':global['bottime'],'thumbnail':fs[_0x41386d(0x111)](_0x41386d(0x105)),'sourceUrl':sig}},'caption':botdate,'footer':text[_0x41386d(0x114)](),'buttons':buttons,'headerType':0x1};await conn[_0x41386d(0x116)](m[_0x41386d(0x109)],buttonMessage,{'quoted':fkontak});
    //
     //------------------- 2BUTTON LOCATION
